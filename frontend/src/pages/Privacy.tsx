      ...
      <div className="flex-1 w-full max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p>Questions or deletion requests? Reach us at <a href="mailto:lovio.space@gmail.com" className="text-foreground underline underline-offset-2">lovio.space@gmail.com</a>.</p>
          </section>
        </div>
      </div>
    </div>
