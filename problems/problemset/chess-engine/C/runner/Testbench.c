...
int main(void){
    ...
    while(line){
        ...
        if(strcmp(cmd,"NEW")==0){
            ...
            char mv[16]="";sscanf(line+4,"%15s",mv);
            char *r=chess_move(g,mv);
            b_cat(&out,r?r:"");b_cat(&out,"\n");if(r)free(r);
        } else if(strcmp(cmd,"PRINT")==0){
            b_cat_free(&out,chess_print(g));
        } else if(strcmp(cmd,"MOVES")==0){
            char sq[8]="";sscanf(line+6,"%7s",sq);
            char *r=chess_moves(g,sq);
            b_cat(&out,r?r:"");b_cat(&out,"\n");if(r)free(r);
        } else if(strcmp(cmd,"STATUS")==0){
            char *r=chess_status(g);
            b_cat(&out,r?r:"");b_cat(&out,"\n");if(r)free(r);
        } else if(strcmp(cmd,"HISTORY")==0){
            b_cat_free(&out,chess_history(g));
        }
